...
<div class="card">
    ...
    <div class="card-header">Bidang</div>
        ...
        <div class="table-scroll">
            ...
            <table>
                ...
                <tbody>
                    ...
                    @forelse ($bidang as $i => $b)
                    <tr
                        data-id="{{ $b->id }}"
                        data-url="{{ route('admin.bidang.update', $b->id) }}">
                        <td>{{ $bidang->firstItem() + $i }}</td>

                        <td class="col-nama" data-field="nama_bidang">
                            {{ $b->nama_bidang }}
                        </td>
                        ...
                        <td class="action-btn">
                            <div class="action-wrapper">
                                ...
                                <a href="{{ route('admin.subbidang', $b->id) }}"
                                    class="btn-action btn-view"
                                    title="Lihat Sub Bidang">
                                ...
                                <button type="button"
                                    ...
                                    data-url="{{ route('admin.bidang.destroy', $b->id) }}"
            ...
            <div class="pagination-wrapper mt-2">
                {{ $bidang->links('pagination::bootstrap-5') }}
            </div>
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('admin.bidang.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" name="nama_bidang" required>
                </div>
    ...
    <div id="importModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h2 class="modal-title">Import Bidang</h2>
                <button class="close-btn" onclick="closeModal('importModal')">&times;</button>
            </div>

            <form action="{{ route('admin.bidang.import') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <small style="display:block; margin-top:8px;">
                        Download template:
                        <a href="{{ asset('template/import_bidang.xlsx') }}" target="_blank">
                            Template Excel Bidang
                        </a>
                    </small>
                </div>
